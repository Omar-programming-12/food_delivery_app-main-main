...
List<FoodModel> foodProduct = [
  FoodModel(
    ...
    imageDetail: 'assets/food-delivery/product/beef_burger.png',
    name: 'Beef Burger',
    price: 7.59,
    rate: 4.5,
  ...
  FoodModel(
    ...
    imageDetail: 'assets/food-delivery/product/double_burger.png',
    name: 'Double Burger',
    price: 10.0,
    rate: 4.9,
  ...
  FoodModel(
    ...
    imageDetail: 'assets/food-delivery/product/cheese-burger.png',
    name: 'Cheese Burger',
    price: 8.88,
    rate: 4.8,
  ...
  FoodModel(
    ...
    imageDetail: 'assets/food-delivery/product/bacon_burger.png',
    name: 'Bacon Burger',
    price: 9.99,
    rate: 5.0,
  ...
  FoodModel(
    imageCard: 'assets/food-delivery/download__3_-removebg-preview.png',
    imageDetail: 'assets/food-delivery/download__3_-removebg-preview.png',
    name: 'Chicken Pizza',
    price: 19.99,
    rate: 4.0,
   ...
   FoodModel(
    ...
    imageDetail: 'assets/food-delivery/product/cup_cake.png',
    name: 'Cream Cake',
    price: 5.99,
    rate: 4.7,

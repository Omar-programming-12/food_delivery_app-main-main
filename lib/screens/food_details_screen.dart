                ...
                children: [
                 const SizedBox(height: 100),
                  Center(
                    ...
                    child: Image.asset(widget.product.imageDetail,height: 320,fit: BoxFit.fill,),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.product.specialItems , style:const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: black,
                            letterSpacing: 1.1
                      ...
                      children: [
                       const TextSpan(
                          text: '\$',style: TextStyle(fontSize: 14,color: red),
                        ),
                        TextSpan(
